...
const products = [
  {
    ...
    isNew: true,
    styles: [
      { name: "彩虹独角兽", type: "normal" },
      { name: "星空独角兽", type: "normal" },
      { name: "樱花独角兽", type: "normal" },
      { name: "海洋独角兽", type: "rare" }
    ]
  },
  {
    id: 2,
    ...
    isNew: false,
    styles: [
      { name: "困倦猫", type: "normal" },
      { name: "好奇猫", type: "normal" },
      { name: "傲娇猫", type: "rare" }
    ]
  },
  {
    ...
    isNew: true,
    styles: [
      { name: "月球宇航员", type: "normal" },
      { name: "火星探测器", type: "normal" },
      { name: "土星环", type: "normal" },
      { name: "银河战舰", type: "rare" }
    ]
  },
  {
    ...
    isNew: true,
    styles: [
      { name: "唐制齐胸", type: "normal" },
      { name: "宋制褙子", type: "normal" },
      { name: "明制马面", type: "normal" }
    ]
  },
  {
    id: 5,
    ...
    isNew: false,
    styles: [
      { name: "草莓蛋糕", type: "normal" },
      { name: "抹茶冰淇淋", type: "normal" },
      { name: "巧克力挞", type: "normal" },
      { name: "马卡龙套装", type: "rare" }
    ]
  },
  {
    id: 6,
    ...
    isNew: true,
    styles: [
      { name: "机械步兵", type: "normal" },
      { name: "电子黑客", type: "normal" },
      { name: "生化改造人", type: "normal" }
    ]
  },
  {
    id: 7,
    ...
    isNew: false,
    styles: [
      { name: "树精灵", type: "normal" },
      { name: "花仙子", type: "normal" },
      { name: "风之精灵", type: "normal" },
      { name: "月光精灵", type: "rare" }
    ]
  },
  {
    ...
    isNew: false,
    styles: [
      { name: "城市公交车", type: "normal" },
      { name: "货运卡车", type: "normal" },
      { name: "直升机", type: "normal" }
    ]
  },
  {
    id: 9,
  ...
  },
  {
    ...
    isNew: true,
    styles: [
      { name: "像素骑士", type: "normal" },
      { name: "魔法巫师", type: "normal" },
      { name: "机械工程师", type: "normal" }
    ]
  }
];
